...
plot(datamod$Global_active_power~datamod$Datetime, type="l", ylab="Global Active Power (kilowatts)", xlab="")
plot(datamod$Voltage~datamod$Datetime, type="l", ylab="Voltage (volt)", xlab="")
...
plot(datamod$Global_reactive_power~datamod$Datetime, type="l",ylab="Global Rective Power (kilowatts)",xlab="")
